...
public class ViewBloodBankActivity extends Activity {
	ListView lv;
	SQLiteDatabase sdb;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent it=new Intent(ViewBloodBankActivity.this,ViewBloodBankDetailsActivity.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_view_blood_bank, menu);
		return true;
	}
